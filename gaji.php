...
class Gaji extends Database
{
    ...
    public function edit($gaji_id1){
       $data_gaji = mysqli_query($this->koneksi,"SELECT gaji.gaji_id,gaji.karyawan_id,
       gaji.gaji_pokok,karyawan.karyawan_nama FROM gaji INNER JOIN karyawan ON
    ...
    public function update($gaji_id1,$karyawan_id1,$gaji_pokok1){
        mysqli_query($this->koneksi,"update gaji set
        karyawan_id='$karyawan_id1',
        gaji_pokok='$gaji_pokok1'
      where gaji_id='$gaji_id1'");
    }
